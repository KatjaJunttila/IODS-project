...
Multiple correspondence analysis with all variables will look quite messy and it's difficult to interpret. I'll concentrate on a few selected variables instead. I'll choose Tea, How, evening, sugar, where, and lunch. Tea tells whether a person drinks Earl Grey, black tea, or green tea. How describes whether tea is drunk alone or with lemon, milk, or other. Evening describes whether tea is enfoyed in the evening or not and sugar whether a person drinks tea with or without sugar. Where includes information on whether tea is bought from a chain store, tea shop, or from both chain store and tea shop. Lunch describes whether or not tea is enjoyed at lunch.
```{r}
